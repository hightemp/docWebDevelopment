...
Read this in [简体中文](https://github.com/skyline75489/what-happens-when-zh_CN) (simplified Chinese), [日本語](https://github.com/tettttsuo/what-happens-when-JA) (Japanese) and [한국어](https://github.com/SantonyChoi/what-happens-when-KR) (Korean). NOTE: these have not been reviewed by the alex/what-happens-when maintainers.
  ...
  * [The "g" key is pressed](#user-content-the-g-key-is-pressed)
  * [The "enter" key bottoms out](#user-content--the-enter-key-bottoms-out)
  * [Interrupt fires [NOT for USB keyboards]](#user-content--interrupt-fires-not-for-usb-keyboards)
  * [(On Windows) A WM_KEYDOWN message is sent to the app](#user-content--on-windows-a-wm_keydown-message-is-sent-to-the-app)
  * [(On OS X) A KeyDown NSEvent is sent to the app](#user-content--on-os-x-a-keydown-nsevent-is-sent-to-the-app)
  * [(On GNU/Linux) the Xorg server listens for keycodes](#user-content--on-gnulinux-the-xorg-server-listens-for-keycodes)
  * [Parse URL](#user-content--parse-url)
  * [Is it a URL or a search term?](#user-content--is-it-a-url-or-a-search-term)
  * [Convert non-ASCII Unicode characters in hostname](#user-content--convert-non-ascii-unicode-characters-in-hostname)
  * [Check HSTS list](#user-content--check-hsts-list)
  * [DNS lookup](#user-content--dns-lookup)
  * [ARP process](#user-content--arp-process)
  * [Opening of a socket](#user-content--opening-of-a-socket)
  * [TLS handshake](#user-content--tls-handshake)
  ...
  * [HTML parsing](#user-content--html-parsing)
  * [CSS interpretation](#user-content--css-interpretation)
  * [Page Rendering](#user-content--page-rendering)
  * [GPU Rendering](#user-content--gpu-rendering)
  * [Window Server](#user-content--window-server)
  * [Post-rendering and user-induced execution](#user-content--post-rendering-and-user-induced-execution)
...
###  [](https://github.com/alex/what-happens-when#on-windows-a-wm_keydown-message-is-sent-to-the-app) (On Windows) A `WM_KEYDOWN` message is sent to the app
...
###  [](https://github.com/alex/what-happens-when#arp-process) ARP process
...
###  [](https://github.com/alex/what-happens-when#opening-of-a-socket) Opening of a socket
...
###  [](https://github.com/alex/what-happens-when#behind-the-scenes-of-the-browser) Behind the scenes of the Browser
