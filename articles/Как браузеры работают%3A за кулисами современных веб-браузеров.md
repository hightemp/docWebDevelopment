...
This comprehensive primer on the internal operations of WebKit and Gecko is the result of much research done by Israeli developer Tali Garsiel. Over a few years, she reviewed all the published data about browser internals(see [Resources](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Resources) )and spent a lot of time reading web browser source code. She wrote:
...
This article has been translated into a few languages: HTML5 Rocks hosts the [German](http://www.html5rocks.com/de/tutorials/internals/howbrowserswork/) , [Spanish](http://www.html5rocks.com/es/tutorials/internals/howbrowserswork/) , [Japanese](http://www.html5rocks.com/ja/tutorials/internals/howbrowserswork/) , [Portuguese](http://www.html5rocks.com/pt/tutorials/internals/howbrowserswork/) , [Russian](http://www.html5rocks.com/ru/tutorials/internals/howbrowserswork/) and [Simplified Chinese](http://www.html5rocks.com/zh/tutorials/internals/howbrowserswork/) versions. You can view the externally hosted translations of [Korean](http://helloworld.naver.com/helloworld/59361) and [Turkish](http://sonsuzdongu.com/blog/tarayicilar-nasil-calisir-modern-web-tarayicilarin-perde-arkasi-cevirisi) as well.
...
1.   [Introduction](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Introduction) 
...
2.   [The rendering engine](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_rendering_engine) 
...
3.   [Parsing and DOM tree construction](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Parsing_general) 
    1.   [Parsing: general](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Parsing_general) 
        1.   [Grammars](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Grammars) 
        2.   [Parser–Lexer combination](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Parser_Lexer_combination) 
        3.   [Translation](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Translation) 
        4.   [Parsing example](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Parsing_example) 
        5.   [Formal definitions for vocabulary and syntax](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Formal_definitions_for_vocabulary_and_syntax) 
        6.   [Types of parsers](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Types_of_parsers) 
        7.   [Generating parsers automatically](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Generating_parsers_automatically) 
    2.   [HTML Parser](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#HTML_Parser) 
        1.   [The HTML grammar definition](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_HTML_grammar_definition) 
        2.   [Not a context free grammar](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Not_a_context_free_grammar) 
        3.   [HTML DTD](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#HTML_DTD) 
        4.   [DOM](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#DOM) 
        5.   [The parsing algorithm](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_parsing_algorithm) 
        6.   [The tokenization algorithm](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_tokenization_algorithm) 
        7.   [Tree construction algorithm](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Tree_construction_algorithm) 
        8.   [Actions when parsing is finished](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Actions_when_the_parsing_is_finished) 
        9.   [Browser error tolerance](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Browsers_error_tolerance) 
    3.   [CSS parsing](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#CSS_parsing) 
        1.   [WebKit CSS parser](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#WebKit_CSS_parser) 
    4.   [The order of processing scripts and style sheets](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_order_of_processing_scripts_and_style_sheets) 
        1.   [Scripts](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Scripts) 
        2.   [Speculative parsing](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Speculative_parsing) 
        3.   [Style sheets](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Style_sheets) 
4.   [Render tree construction](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Render_tree_construction) 
    1.   [The render tree relation to the DOM tree](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_render_tree_relation_to_the_DOM_tree) 
    2.   [The flow of constructing the tree](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_flow_of_constructing_the_tree) 
    3.   [Style Computation](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Style_Computation) 
        1.   [Sharing style data](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Sharing_style_data) 
        2.   [Firefox rule tree](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Firefox_rule_tree) 
        ...
        4.   [Applying the rules in the correct cascade order](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Applying_the_rules_in_the_correct_cascade_order) 
            1.   [Style sheet cascade order](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Style_sheet_cascade_order) 
            2.   [Specificity](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Specificity) 
            3.   [Sorting the rules](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Sorting_the_rules) 
    4.   [Gradual process](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Gradual_process) 
5.   [Layout](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Layout) 
    1.   [Dirty bit system](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Dirty_bit_system) 
    2.   [Global and incremental layout](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Global_and_incremental_layout) 
    3.   [Asynchronous and synchronous layout](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Asynchronous_and_Synchronous_layout) 
    4.   [Optimizations](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Optimizations) 
    5.   [The layout process](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_layout_process) 
    6.   [Width calculation](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Width_calculation) 
    7.   [Line breaking](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Line_Breaking) 
6.   [Painting](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Painting) 
    1.   [Global and incremental](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Global_and_Incremental) 
    2.   [The painting order](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_painting_order) 
    3.   [Firefox display list](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Firefox_display_list) 
    4.   [WebKit rectangle storage](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#WebKit_rectangle_storage) 
7.   [Dynamic changes](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Dynamic_changes) 
8.   [The rendering engine's threads](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_rendering_engines_threads) 
    1.   [Event loop](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Event_loop) 
9.   [CSS2 visual model](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#css) 
    1.   [The canvas](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#The_canvas) 
    2.   [CSS box model](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#CSS_Box_model) 
    3.   [Positioning scheme](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Positioning_scheme) 
    4.   [Box types](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Box_types) 
    5.   [Positioning](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Positioning) 
        1.   [Relative](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Relative) 
        2.   [Floats](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Floats) 
        3.   [Absolute and fixed](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Absolute_and_fixed) 
    6.   [Layered representation](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Layered_representation) 
10.   [Resources](https://www.html5rocks.com/en/tutorials/internals/howbrowserswork/#Resources) 
...
The way the browser interprets and displays HTML files is specified in the HTML and CSS specifications. These specifications are maintained by theW3C(World Wide Web Consortium) organization, which is the standards organization for the web. For years browsers conformed to only a part of the specifications and developed their own extensions. That caused serious compatibility issues for web authors. Today most of the browsers more or less conform to the specifications.
...
For example, parsing the expression2 + 3 - 1could return this tree:
...
Let's analyze the input2 + 3 - 1.  
The first substring that matches a rule is2: according to rule #5 it is a term. The second match is2 + 3: this matches the third rule: a term followed by an operation followed by another term. The next match will only be hit at the end of the input.2 + 3 - 1is an expression because we already know that2 + 3is a term, so we have a term followed by an operation followed by another term.2 + +will not match any rule and therefore is an invalid input.
...
We said that a language can be parsed by regular parsers if its grammar is acontext free grammar. An intuitive definition of a context free grammar is a grammar that can be entirely expressed in BNF. For a formal definition see [Wikipedia's article on Context-free grammar](http://en.wikipedia.org/wiki/Context-free_grammar) 
...
The top down parser will start from the higher level rule: it will identify2 + 3as an expression. It will then identify2 + 3 - 1as an expression (the process of identifying the expression evolves, matching the other rules, but the start point is the highest level rule).
