...
* [The browsers we will talk about](#user-content-the-browsers-we-will-talk-about)
* [The browser's main functionality](#user-content-the-browsers-main-functionality)
* [The browser's high level structure](#user-content-the-browsers-high-level-structure)
* [The rendering engine](#user-content-the-rendering-engine)
* [Rendering engines](#user-content-rendering-engines)
* [The main flow](#user-content-the-main-flow)
  * [Main flow examples](#user-content-main-flow-examples)
  * [Parsing–general](#user-content-parsinggeneral)
  * [Grammars](#user-content-grammars)
  * [Parser–Lexer combination](#user-content-parserlexer-combination)
  * [Translation](#user-content-translation)
  * [Parsing example](#user-content-parsing-example)
  * [Formal definitions for vocabulary and syntax](#user-content-formal-definitions-for-vocabulary-and-syntax)
  * [Types of parsers](#user-content-types-of-parsers)
  * [Generating parsers automatically](#user-content-generating-parsers-automatically)
* [HTML Parser](#user-content-html-parser)
  * [The HTML grammar definition](#user-content-the-html-grammar-definition)
  * [Not a context free grammar](#user-content-not-a-context-free-grammar)
  * [HTML DTD](#user-content-html-dtd)
  * [DOM](#user-content-dom)
    * [The parsing algorithm](#user-content-the-parsing-algorithm)
  * [The tokenization algorithm](#user-content-the-tokenization-algorithm)
    * [Tree construction algorithm](#user-content-tree-construction-algorithm)
  * [Actions when the parsing is finished](#user-content-actions-when-the-parsing-is-finished)
  * [Browsers' error tolerance](#user-content-browsers-error-tolerance)
    * [\</br> instead of \<br>](#user-content-br-instead-of-br)
    * [A stray table](#user-content-a-stray-table)
    * [Nested form elements](#user-content-nested-form-elements)
    * [A too deep tag hierarchy](#user-content-a-too-deep-tag-hierarchy)
    * [Misplaced html or body end tags](#user-content-misplaced-html-or-body-end-tags)
    * [CSS parsing](#user-content-css-parsing)
  * [WebKit CSS parser](#user-content-webkit-css-parser)
* [The order of processing scripts and style sheets](#user-content-the-order-of-processing-scripts-and-style-sheets)
    * [Scripts](#user-content-scripts)
  * [Speculative parsing](#user-content-speculative-parsing)
  * [Style sheets](#user-content-style-sheets)
* [Render tree construction](#user-content-render-tree-construction)
  * [The render tree relation to the DOM tree](#user-content-the-render-tree-relation-to-the-dom-tree)
    * [The flow of constructing the tree](#user-content-the-flow-of-constructing-the-tree)
  * [Style Computation](#user-content-style-computation)
  * [Sharing style data](#user-content-sharing-style-data)
  * [Firefox rule tree](#user-content-firefox-rule-tree)
  * [Division into structs](#user-content-division-into-structs)
  * [Computing the style contexts using the rule tree](#user-content-computing-the-style-contexts-using-the-rule-tree)
  * [Manipulating the rules for an easy match](#user-content-manipulating-the-rules-for-an-easy-match)
  * [Applying the rules in the correct cascade order](#user-content-applying-the-rules-in-the-correct-cascade-order)
  * [Style sheet cascade order](#user-content-style-sheet-cascade-order)
  * [Specificity](#user-content-specificity)
  * [Sorting the rules](#user-content-sorting-the-rules)
  * [Gradual process](#user-content-gradual-process)
* [Layout](#user-content-layout)
  * [Dirty bit system](#user-content-dirty-bit-system)
  * [Global and incremental layout](#user-content-global-and-incremental-layout)
  * [Asynchronous and Synchronous layout](#user-content-asynchronous-and-synchronous-layout)
  * [Optimizations](#user-content-optimizations)
  * [The layout process](#user-content-the-layout-process)
  * [Width calculation](#user-content-width-calculation)
  * [Line Breaking](#user-content-line-breaking)
* [Painting](#user-content-painting)
  * [Global and Incremental](#user-content-global-and-incremental)
  * [The painting order](#user-content-the-painting-order)
  * [Firefox display list](#user-content-firefox-display-list)
    * [WebKit rectangle storage](#user-content-webkit-rectangle-storage)
  * [Dynamic changes](#user-content-dynamic-changes)
  * [The rendering engine's threads](#user-content-the-rendering-engines-threads)
  * [Event loop](#user-content-event-loop)
* [CSS2 visual model](#user-content-css2-visual-model)
  * [The canvas](#user-content-the-canvas)
  * [CSS Box model](#user-content-css-box-model)
  * [Positioning scheme](#user-content-positioning-scheme)
  * [Box types](#user-content-box-types)
  * [Positioning](#user-content-positioning)
    * [Relative](#user-content-relative)
    * [Floats](#user-content-floats)
    * [Absolute and fixed](#user-content-absolute-and-fixed)
  * [Layered representation](#user-content-layered-representation)
